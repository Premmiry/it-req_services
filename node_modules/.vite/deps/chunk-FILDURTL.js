...
} from "./chunk-WP7TYSFZ.js";
import {
  Autocomplete_default,
  Badge_default,
  CircularProgress_default,
  Skeleton_default
} from "./chunk-4NAB64FT.js";
import {
  Typography_default
} from "./chunk-4S5QVRYW.js";
import {
  CssBaseline_default
} from "./chunk-EXDWKQZX.js";
import {
  IconButton_default
} from "./chunk-UNFAYLWZ.js";
import {
  InitColorSchemeScript_default,
  ThemeProvider,
  useColorScheme,
  useThemeProps
} from "./chunk-JXUYRRZA.js";
import {
  ButtonGroupContext_default,
  Button_default
} from "./chunk-7YL4IN2I.js";
import {
  useMediaQuery
} from "./chunk-FQXEM6BC.js";
import {
  require_Close
} from "./chunk-7ZZ6LQFT.js";
import {
  Rating_default
} from "./chunk-YEVPFT2G.js";
import {
  init_utils,
  useId_default
} from "./chunk-EHDMDCIE.js";
import {
  isMuiElement_default
} from "./chunk-6CKRSX2D.js";
import {
  capitalize_default
} from "./chunk-PNZ3IJIS.js";
import {
  init_DefaultPropsProvider,
  useDefaultProps
} from "./chunk-6KEASGCJ.js";
import {
  styled_default
} from "./chunk-J3LX2AKF.js";
import {
...
function useSlotProps2(parameters) {
  ...
  const resolvedComponentsProps = skipResolvingSlotProps ? {} : resolveComponentProps2(externalSlotProps, ownerState);
  const {
    props: mergedProps,
    internalRef
  ...
  const props = appendOwnerState2(elementType, _extends({}, mergedProps, {
    ref
  }), ownerState);
  return props;
}
...
var Badge = React23.forwardRef(function Badge2(props, forwardedRef) {
  ...
  const badgeProps = useSlotProps2({
...
function useButton(parameters = {}) {
  ...
  const getRootProps = (externalProps = {}) => {
    const externalEventHandlers = _extends({}, extractEventHandlers2(parameters), extractEventHandlers2(externalProps));
...
function ClickAwayListener(props) {
  ...
  return (0, import_jsx_runtime10.jsx)(React26.Fragment, {
...
function useInput(parameters = {}) {
  ...
  const getRootProps = (externalProps = {}) => {
    const propsEventHandlers = extractEventHandlers2(parameters, ["onBlur", "onChange", "onFocus"]);
    const externalEventHandlers = _extends({}, propsEventHandlers, extractEventHandlers2(externalProps));
...
var Input = React36.forwardRef(function Input2(props, forwardedRef) {
  ...
  const inputProps = useSlotProps2({
...
function useList(params) {
  ...
  const getRootProps = (externalProps = {}) => {
    const externalEventHandlers = extractEventHandlers2(externalProps);
...
function useMenu(parameters = {}) {
  ...
  const {
    ...
    triggerElement,
    registerPopup
  } = (_React$useContext = React43.useContext(DropdownContext)) != null ? _React$useContext : FALLBACK_MENU_CONTEXT;
...
var Portal = React45.forwardRef(function Portal2(props, forwardedRef) {
  ...
  if (disablePortal) {
    ...
    return (0, import_jsx_runtime18.jsx)(React45.Fragment, {
      children
    });
  }
  return (0, import_jsx_runtime18.jsx)(React45.Fragment, {
...
var Menu = React51.forwardRef(function Menu2(props, forwardedRef) {
  ...
  const listboxProps = useSlotProps2({
    elementType: Listbox,
...
function useModal(parameters) {
  ...
  const getRootProps = (otherHandlers = {}) => {
    const propsEventHandlers = extractEventHandlers2(parameters);
...
var Modal = React58.forwardRef(function Modal2(props, forwardedRef) {
  ...
  const backdropProps = useSlotProps2({
...
function NoSsr(props) {
  ...
  return (0, import_jsx_runtime25.jsx)(React59.Fragment, {
...
var NumberInput = React61.forwardRef(function NumberInput2(props, forwardedRef) {
  ...
  const incrementButtonProps = useSlotProps2({
  ...
  const decrementButtonProps = useSlotProps2({
...
var OptionGroup = React62.forwardRef(function OptionGroup2(props, forwardedRef) {
  ...
  const labelProps = useSlotProps2({
    elementType: Label,
    externalSlotProps: slotProps.label,
    ownerState: props,
    className: classes.label
  });
  const listProps = useSlotProps2({
    elementType: List,
...
function defaultRenderValue(selectedOptions) {
  ...
  if (Array.isArray(selectedOptions)) {
    return (0, import_jsx_runtime33.jsx)(React69.Fragment, {
...
var Select = React69.forwardRef(function Select2(props, forwardedRef) {
  ...
  const buttonProps = useSlotProps2({
    elementType: Button3,
  ...
  const popupProps = useSlotProps2({
...
function useSlider(parameters) {
  ...
  const getRootProps = (externalProps = {}) => {
    const externalHandlers = extractEventHandlers2(externalProps);
...
var Slider = React71.forwardRef(function Slider2(props, forwardedRef) {
  ...
  const trackProps = useSlotProps2({
    elementType: Track,
  ...
  const thumbProps = useSlotProps2({
    elementType: Thumb,
  ...
  const valueLabelProps = useSlotProps2({
    elementType: ValueLabel,
    externalSlotProps: slotProps.valueLabel,
    ownerState
  });
  const Mark = (_slots$mark = slots.mark) != null ? _slots$mark : "span";
  const markProps = useSlotProps2({
    elementType: Mark,
  ...
  const markLabelProps = useSlotProps2({
  ...
  return (0, import_jsx_runtime36.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime35.jsx)(Rail, _extends({}, railProps)), (0, import_jsx_runtime35.jsx)(Track, _extends({}, trackProps)), marks.filter((mark) => mark.value >= min && mark.value <= max).map((mark, index) => {
      ...
      return (0, import_jsx_runtime36.jsxs)(React71.Fragment, {
        children: [(0, import_jsx_runtime35.jsx)(Mark, _extends({
          "data-index": index
        }, markProps, !isHostComponent2(Mark) && {
          markActive
        }, {
          ...
          "aria-hidden": true,
          "data-index": index
        }, markLabelProps, !isHostComponent2(MarkLabel) && {
      ...
      return (0, import_jsx_runtime36.jsxs)(Thumb, _extends({
        ...
        children: [(0, import_jsx_runtime35.jsx)(Input3, _extends({
          ...
          value: values[index]
        }, inputProps)), ValueLabel ? (0, import_jsx_runtime35.jsx)(ValueLabel, _extends({}, !isHostComponent2(ValueLabel) && {
          valueLabelFormat,
          index,
          disabled
        }, valueLabelProps, {
...
var Snackbar = React73.forwardRef(function Snackbar2(props, forwardedRef) {
  ...
  const clickAwayListenerProps = useSlotProps2({
...
var TablePaginationActions = React76.forwardRef(function TablePaginationActions2(props, forwardedRef) {
  ...
  const firstButtonProps = useSlotProps2({
  ...
  const lastButtonProps = useSlotProps2({
  ...
  const nextButtonProps = useSlotProps2({
  ...
  const backButtonProps = useSlotProps2({
...
var TablePagination = React77.forwardRef(function TablePagination2(props, forwardedRef) {
  ...
  const selectProps = useSlotProps2({
    elementType: Select3,
  ...
  const actionsProps = useSlotProps2({
    elementType: Actions,
  ...
  const menuItemProps = useSlotProps2({
  ...
  const selectLabelProps = useSlotProps2({
  ...
  const displayedRowsProps = useSlotProps2({
  ...
  const spacerProps = useSlotProps2({
    elementType: Spacer,
...
var Tabs = React81.forwardRef(function Tabs2(props, forwardedRef) {
  ...
  const tabsRootProps = useSlotProps2({
...
var TabPanel = React83.forwardRef(function TabPanel2(props, forwardedRef) {
  ...
  const tabPanelRootProps = useSlotProps2({
  ...
  return (0, import_jsx_runtime46.jsx)(TabPanelRoot2, _extends({}, tabPanelRootProps, {
...
var TabsList = React86.forwardRef(function TabsList2(props, forwardedRef) {
  ...
  const tabsListRootProps = useSlotProps2({
...
var Tab = React88.forwardRef(function Tab2(props, forwardedRef) {
  ...
  const tabRootProps = useSlotProps2({
    elementType: TabRoot,
    getSlotProps: getRootProps,
    externalSlotProps: slotProps.root,
    externalForwardedProps: other,
...
var TextareaAutosize = React89.forwardRef(function TextareaAutosize2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime51.jsxs)(React89.Fragment, {
...
var LoadingButton = React93.forwardRef(function LoadingButton2(inProps, ref) {
  ...
  const loadingIndicator = loadingIndicatorProp != null ? loadingIndicatorProp : (0, import_jsx_runtime54.jsx)(CircularProgress_default, {
    "aria-labelledby": id,
    color: "inherit",
    size: 16
  });
  ...
  const loadingButtonLoadingIndicator = loading ? (0, import_jsx_runtime54.jsx)(LoadingButtonLoadingIndicator, {
    className: classes.loadingIndicator,
    ownerState,
    children: loadingIndicator
  }) : null;
  return (0, import_jsx_runtime55.jsxs)(LoadingButtonRoot, _extends({
...
var Pagination_default2 = React100.forwardRef(function DeprecatedPagination(props, ref) {
  ...
  return (0, import_jsx_runtime56.jsx)(Pagination_default, _extends({
    ref
  }, props));
});
...
var PaginationItem_default2 = React101.forwardRef(function DeprecatedPaginationItem(props, ref) {
  ...
  return (0, import_jsx_runtime57.jsx)(PaginationItem_default, _extends({
    ref
  }, props));
});
...
var Rating_default2 = React104.forwardRef(function DeprecatedRating(props, ref) {
  ...
  return (0, import_jsx_runtime58.jsx)(Rating_default, _extends({
    ref
  }, props));
});
...
var Skeleton_default2 = React105.forwardRef(function DeprecatedSkeleton(props, ref) {
  ...
  return (0, import_jsx_runtime59.jsx)(Skeleton_default, _extends({
    ref
  }, props));
});
...
var SpeedDialAction_default2 = React107.forwardRef(function DeprecatedSpeedDialAction(props, ref) {
  ...
  return (0, import_jsx_runtime61.jsx)(SpeedDialAction_default, _extends({
    ref
  }, props));
});
...
var SpeedDialIcon_default2 = React108.forwardRef(function DeprecatedSpeedDialIcon(props, ref) {
  ...
  return (0, import_jsx_runtime62.jsx)(SpeedDialIcon_default, _extends({
    ref
  }, props));
});
...
function TabContext(props) {
  ...
  return (0, import_jsx_runtime63.jsx)(Context.Provider, {
    value: context,
    children
  });
}
...
var TabList = React114.forwardRef(function TabList2(props, ref) {
  ...
  return (0, import_jsx_runtime64.jsx)(Tabs_default, _extends({}, other, {
    ref,
    value: context.value,
    children
  }));
...
var TabPanel3 = React115.forwardRef(function TabPanel4(inProps, ref) {
  ...
  return (0, import_jsx_runtime65.jsx)(TabPanelRoot, _extends({
...
var Timeline = React118.forwardRef(function Timeline2(inProps, ref) {
  ...
  return (0, import_jsx_runtime66.jsx)(TimelineContext_default.Provider, {
    value: contextValue,
    children: (0, import_jsx_runtime66.jsx)(TimelineRoot, _extends({
      className: clsx_default(classes.root, className),
      ownerState,
      ref
    }, other))
...
var TimelineConnector = React119.forwardRef(function TimelineConnector2(inProps, ref) {
  ...
  return (0, import_jsx_runtime67.jsx)(TimelineConnectorRoot, _extends({
    className: clsx_default(classes.root, className),
    ownerState,
    ref
  }, other));
...
var TimelineContent = React120.forwardRef(function TimelineContent2(inProps, ref) {
  ...
  return (0, import_jsx_runtime68.jsx)(TimelineContentRoot, _extends({
    component: "div",
    className: clsx_default(classes.root, className),
    ownerState,
    ref
...
var TimelineDot = React121.forwardRef(function TimelineDot2(inProps, ref) {
  ...
  return (0, import_jsx_runtime69.jsx)(TimelineDotRoot, _extends({
    className: clsx_default(classes.root, className),
    ownerState,
    ref
  }, other));
...
var TimelineOppositeContent = React122.forwardRef(function TimelineOppositeContent2(inProps, ref) {
  ...
  return (0, import_jsx_runtime70.jsx)(TimelineOppositeContentRoot, _extends({
    component: "div",
    className: clsx_default(classes.root, className),
    ownerState,
    ref
...
var TimelineItem = React123.forwardRef(function TimelineItem2(inProps, ref) {
  ...
  return (0, import_jsx_runtime71.jsx)(TimelineContext_default.Provider, {
    value: contextValue,
    children: (0, import_jsx_runtime71.jsx)(TimelineItemRoot, _extends({
      className: clsx_default(classes.root, className),
      ownerState,
      ref
    }, other))
...
var TimelineSeparator = React124.forwardRef(function TimelineSeparator2(inProps, ref) {
  ...
  return (0, import_jsx_runtime72.jsx)(TimelineSeparatorRoot, _extends({
    className: clsx_default(classes.root, className),
    ownerState,
    ref
  }, other));
...
var ToggleButton_default2 = React125.forwardRef(function DeprecatedToggleButton(props, ref) {
  ...
  return (0, import_jsx_runtime73.jsx)(ToggleButton_default, _extends({
    ref
  }, props));
});
...
var ToggleButtonGroup_default2 = React126.forwardRef(function DeprecatedToggleButtonGroup(props, ref) {
  ...
  return (0, import_jsx_runtime74.jsx)(ToggleButtonGroup_default, _extends({
    ref
  }, props));
});
...
var Masonry = React129.forwardRef(function Masonry2(inProps, ref) {
  ...
  const lineBreaks = new Array(numberOfLineBreaks).fill("").map((_, index) => (0, import_jsx_runtime75.jsx)("span", {
    "data-class": "line-break",
    style: _extends({}, lineBreakStyle, {
      order: index + 1
    })
  }, index));
  return (0, import_jsx_runtime76.jsxs)(MasonryRoot, _extends({
    as: component,
    className: clsx_default(classes.root, className),
    ref: handleRef,
    ownerState
...
function DialogsProvider(props) {
  ...
  return (0, import_jsx_runtime78.jsxs)(DialogsContext.Provider, {
    value: contextValue,
    children: [children, stack.map(({
      ...
      payload,
      promise
    }) => (0, import_jsx_runtime78.jsx)(Component, {
      payload,
      open,
...
var BrandingContext = React133.createContext(null);
var NavigationContext = React133.createContext([]);
var PaletteModeContext = React133.createContext({
  paletteMode: "light",
  setPaletteMode: () => {
  },
  isDualTheme: false
});
var RouterContext = React133.createContext(null);
var WindowContext = React133.createContext(void 0);
var DocsContext = React133.createContext(false);
...
function LegacyThemeProvider(props) {
  ...
  return (0, import_jsx_runtime79.jsx)(ThemeProvider, {
    ...
    children: (0, import_jsx_runtime79.jsxs)(PaletteModeContext.Provider, {
      value: paletteModeContextValue,
      children: [_CssBaseline || (_CssBaseline = (0, import_jsx_runtime79.jsx)(CssBaseline_default, {
...
function CssVarsPaletteModeProvider(props) {
  ...
  return (0, import_jsx_runtime79.jsx)(PaletteModeContext.Provider, {
    value: paletteModeContextValue,
    ...props
  });
}
function CssVarsThemeProvider(props) {
  ...
  return (0, import_jsx_runtime79.jsxs)(ThemeProvider, {
    theme,
    documentNode: appWindow == null ? void 0 : appWindow.document,
    ...
    colorSchemeStorageKey: COLOR_SCHEME_STORAGE_KEY,
    modeStorageKey: MODE_STORAGE_KEY,
    children: [_InitColorSchemeScrip || (_InitColorSchemeScrip = (0, import_jsx_runtime79.jsx)(InitColorSchemeScript_default, {
      attribute: COLOR_SCHEME_ATTRIBUTE,
      colorSchemeStorageKey: COLOR_SCHEME_STORAGE_KEY,
      modeStorageKey: MODE_STORAGE_KEY
    })), (0, import_jsx_runtime79.jsxs)(CssVarsPaletteModeProvider, {
      children: [_CssBaseline2 || (_CssBaseline2 = (0, import_jsx_runtime79.jsx)(CssBaseline_default, {
        enableColorScheme: true
      })), children]
    })]
  });
...
function AppThemeProvider(props) {
  ...
  return useCssVarsProvider ? (0, import_jsx_runtime79.jsx)(CssVarsThemeProvider, {
    theme,
    ...rest,
    children
  }) : (0, import_jsx_runtime79.jsx)(LegacyThemeProvider, {
    theme,
    ...rest,
    children
  });
...
function AppProvider(props) {
  ...
  return (0, import_jsx_runtime80.jsx)(WindowContext.Provider, {
    value: appWindow,
    children: (0, import_jsx_runtime80.jsx)(AuthenticationContext.Provider, {
      value: authentication,
      children: (0, import_jsx_runtime80.jsx)(SessionContext.Provider, {
        value: session,
        children: (0, import_jsx_runtime80.jsx)(RouterContext.Provider, {
          value: router,
          children: (0, import_jsx_runtime80.jsx)(AppThemeProvider, {
            theme,
            window: appWindow,
            children: (0, import_jsx_runtime80.jsx)(NotificationsProvider, {
              children: (0, import_jsx_runtime80.jsx)(DialogsProvider, {
                children: (0, import_jsx_runtime80.jsx)(BrandingContext.Provider, {
                  value: branding,
                  children: (0, import_jsx_runtime80.jsx)(NavigationContext.Provider, {
                    value: navigation,
                    children
                  })
                })
...
true ? AppProvider.propTypes = {
  ...
  router: import_prop_types43.default.shape({
    ...
    searchParams: import_prop_types43.default.instanceOf(URLSearchParams)
  }),
  /**
...
@mui/lab/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-FILDURTL.js.map
